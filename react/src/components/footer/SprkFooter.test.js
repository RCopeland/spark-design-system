...
describe('SprkFooter:', () => {
  ...
  it('should display a Footer element with the column links section', () => {
    const linkColumns = [
      {
        heading: 'Site Links',
        links: [
  ...
  it('should display a Footer element with the connect icons section', () => {
    const connectIcons = {
  ...
  it('should display a Footer element with the awards section', () => {
    const awards = {
  ...
  it('should display a Footer element with the additional icons section', () => {
